...
const getAllDatasets = async (req, res, next) => {
    try {
        ...
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.getAllDatasets - workspace ${workspaceId} not found!`);
        }
        const apiResponse = await dataset_1.default.getAllDatasets(workspaceId, page, limit);
...
const getDataset = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.getDataset - workspace ${workspaceId} not found!`);
        }
        const apiResponse = await dataset_1.default.getDataset(req.params.id, workspaceId, page, limit);
        return res.json(apiResponse);
    }
    catch (error) {
        next(error);
...
const createDataset = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.createDataset - workspace ${workspaceId} not found!`);
        }
...
const updateDataset = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.updateDataset - workspace ${workspaceId} not found!`);
        }
        const apiResponse = await dataset_1.default.updateDataset(req.params.id, req.body, workspaceId);
        return res.json(apiResponse);
    }
    catch (error) {
        next(error);
...
const deleteDataset = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.deleteDataset - workspace ${workspaceId} not found!`);
        }
        const apiResponse = await dataset_1.default.deleteDataset(req.params.id, workspaceId);
        return res.json(apiResponse);
    }
    catch (error) {
        next(error);
...
const addDatasetRow = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.addDatasetRow - workspace ${workspaceId} not found!`);
        }
...
const updateDatasetRow = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.updateDatasetRow - workspace ${workspaceId} not found!`);
        }
        req.body.workspaceId = workspaceId;
...
const deleteDatasetRow = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.deleteDatasetRow - workspace ${workspaceId} not found!`);
        }
        const apiResponse = await dataset_1.default.deleteDatasetRow(req.params.id, workspaceId);
        return res.json(apiResponse);
    }
    catch (error) {
        next(error);
...
const patchDeleteRows = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.patchDeleteRows - workspace ${workspaceId} not found!`);
        }
        const apiResponse = await dataset_1.default.patchDeleteRows(ids, workspaceId);
        return res.json(apiResponse);
    }
    catch (error) {
        next(error);
...
const reorderDatasetRow = async (req, res, next) => {
    try {
        ...
        const workspaceId = req.user?.activeWorkspaceId;
        if (!workspaceId) {
            throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: datasetController.reorderDatasetRow - workspace ${workspaceId} not found!`);
        }
        const apiResponse = await dataset_1.default.reorderDatasetRow(req.body.datasetId, req.body.rows, workspaceId);
        return res.json(apiResponse);
    }
    catch (error) {
        next(error);
