...
const generateTextToSpeech = async (req, res) => {
    try {
        ...
        if (chatflowId) {
            ...
            if (!workspaceId) {
                throw new internalFlowiseError_1.InternalFlowiseError(http_status_codes_1.StatusCodes.NOT_FOUND, `Error: textToSpeechController.generateTextToSpeech - workspace ${workspaceId} not found!`);
            }
