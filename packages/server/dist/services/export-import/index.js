...
const exportData = async (exportInput, activeWorkspaceId) => {
    try {
        ...
        let AssistantCustom = exportInput.assistantCustom === true ? await assistants_2.default.getAllAssistants(activeWorkspaceId, 'CUSTOM') : [];
        ...
        let AssistantOpenAI = exportInput.assistantOpenAI === true ? await assistants_2.default.getAllAssistants(activeWorkspaceId, 'OPENAI') : [];
        let AssistantAzure = exportInput.assistantAzure === true ? await assistants_2.default.getAllAssistants(activeWorkspaceId, 'AZURE') : [];
